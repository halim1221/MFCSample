...
MFCSample.h
    ...
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CMFCSampleApp アプリケーション クラスを宣言します。

MFCSample.cpp
    これはメインのアプリケーション ソース ファイルで、CMFCSampleApp アプリケーション クラスが含まれています。
...
MFCSampleDlg.h, MFCSampleDlg.cpp - ダイアログ
    これらのファイルには、CMFCSampleDlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる MFCSample.rc に含まれています。
